...
import 'package:ams_android/features/login/cubit/login_view_model.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<LoginViewModel, LoginState>(
      stateListener: (context, state) {
        if (state.status == LoginStatus.success) {
          NavigationHandler.instance.navigateTo(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLoginButton(viewModel, screenHeight, orientation),
